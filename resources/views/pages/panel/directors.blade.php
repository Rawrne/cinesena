...
@section('title', 'Panel - Directores')
        ...
        <div class="row">
            <div class="col-md mb-3">
                <div>
                    ...
                    <input type="text" class="form-control" id="name" name="name" autocomplete="off" placeholder="Nombre del Director" required>
                </div>
            </div>
            <div class="col-md mb-3">
                <div>
        ...
        <div class="row">
            <div class="col-md mb-3">
                <div>
                    ...
                    <textarea class="form-control" id="description" name="description" autocomplete="off" placeholder="La descripción del Director..." rows="4"></textarea>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    @forelse ($directors as $director)
                        <tr>
                            ...
                            <td>{{$director->name}}</td>
                            <td>{{$director->country ?? "Sin Origen"}}</td>
                            <td class="text-center">
                                <form method="post" onsubmit="return confirm('¿Estás seguro de que quieres eliminar a {{$director->name}}?');">
                                    @csrf
                                    @method("DELETE")
                    ...
                    @empty
                        <tr>
                            <td colspan="4">No hay directores...</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
