...
@section('title', 'Panel - Escritores')
        ...
        <div class="row">
            <div class="col-md mb-3">
                <div>
                    ...
                    <input type="text" class="form-control" id="name" name="name" autocomplete="off" placeholder="Nombre del Escritor" required>
                </div>
            </div>
            <div class="col-md mb-3">
                <div>
        ...
        <div class="row">
            <div class="col-md mb-3">
                <div>
                    ...
                    <textarea class="form-control" id="description" name="description" autocomplete="off" placeholder="La descripción del Escritor..." rows="4"></textarea>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    @forelse ($writers as $writer)
                        <tr>
                            ...
                            <td>{{$writer->name}}</td>
                            <td>{{$writer->country ?? "Sin Origen"}}</td>
                            <td class="text-center">
                                <form method="post" onsubmit="return confirm('¿Estás seguro de que quieres eliminar a {{$writer->name}}?');">
                                    @csrf
                                    @method("DELETE")
                    ...
                    @empty
                        <tr>
                            <td colspan="4">No hay Escritores...</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
